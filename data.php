<?php
    ...
    if(isset($_POST['bsimpan']))
    {
        ...
        else
        {
            ...
            $simpan = mysqli_query($koneksi, "insert into muridbaru (NISN_siswa, TTL, nama_siswa, jenis_kelamin, nama_ortu, alamat, no_hp, jurusan, email, foto) 
            values ('$_POST[tNISN_siswa]','$_POST[tTTL]','$_POST[tnama_siswa]','$_POST[tjenis_kelamin]','$_POST[tnama_ortu]', '$_POST[talamat]','$_POST[tno_hp]', '$_POST[tjurusan]', '$_POST[temail]', '$_POST[tfoto]')");
...
<div class="card-body">
    ...
    <div class="form-group">
        ...
        <input type="file" name="tfoto" value="<?=@$vfoto?>" class="form-control" required>
        </div>
